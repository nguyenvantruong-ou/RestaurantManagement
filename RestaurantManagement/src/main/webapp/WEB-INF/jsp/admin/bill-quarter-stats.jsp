...
<h1 class="title">THỐNG KÊ DOANH THU THEO QUÝ</h1>
...
<div class="container">
    <div>
        ...
        <div class="row">
            <div class="col-md-8">
                <canvas id="myBillQuarterChart"></canvas>
            </div>
            <div class="col-md-4">
                <table class="content-table">
                    ...
                    <tbody>
                        <c:forEach var="b" items="${billQuarterStats}">
                            <tr>
                                <td>${b[0]}/${b[1]}</td>
                                <td><fmt:formatNumber value = "${b[2]}" type = "number"/> VND</td>
                            </tr>
                        </c:forEach>
                    </tbody>
                </table>
...
<script>
    ...
    <c:forEach items="${billQuarterStats}" var="b">
    billLabels.push('${b[0]}/${b[1]}')
        billInfo.push(${b[2]})
    </c:forEach>
        window.onload = function () {
            billQuarterChart("myBillQuarterChart", billLabels, billInfo)
        }
</script>