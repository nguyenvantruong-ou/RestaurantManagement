...
<h1 class="title">THỐNG KÊ DOANH THU THEO THÁNG</h1>
...
<div class="container">
    <div>
        ...
        <div>
            <canvas id="myBillMonthChart"></canvas>
        </div>
        <table class="content-table">
            ...
            <tbody>
                <c:forEach var="b" items="${billMonthStats}">
                    <tr>
                        <td>${b[0]}/${b[1]}</td>
...
<script>
    ...
    <c:forEach items="${billMonthStats}" var="b">
    billLabels.push('${b[0]}/${b[1]}')
        billInfo.push(${b[2]})
    </c:forEach>
        window.onload = function () {
            billMonthChart("myBillMonthChart", billLabels, billInfo)
        }
</script>