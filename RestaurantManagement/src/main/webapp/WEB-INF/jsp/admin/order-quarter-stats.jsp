...
<h1 class="title">THỐNG KÊ MẬT ĐỘ ĐẶT TIỆC THEO QUÝ</h1>
...
<div class="container">
    <div>
        ...
        <div class="row">
            <div class="col-md-8">
                <canvas id="myOrderQuarterChart"></canvas>
            </div>
            <div class="col-md-4">
                <table class="content-table">
                    ...
                    <tbody>
                        <c:forEach var="o" items="${orderQuarterStats}">
                            <tr>
                                <td>${o[0]}/${o[1]}</td>
                                <td>${o[2]}</td>
                            </tr>
...
<script>
    let labels = [], info = [];
    <c:forEach items="${orderQuarterStats}" var="o">
        labels.push('${o[0]}/${o[1]}')
        info.push(${o[2]})
    </c:forEach>
    window.onload = function () {
        billQuarterChart("myOrderQuarterChart", labels, info)
    }
</script>